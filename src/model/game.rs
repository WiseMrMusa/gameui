...
impl GameState {   
    ...
    pub fn jumble_board(&mut self) {
        ...
        self.board[0][1] = BoardPiece::Black;
    }
    ...
    pub fn handle_click(&mut self, row: usize, col: usize) {
        ...
        if self.pieces_dropped[self.index_of_pieces(self.current_player)] >= 4 {
            return;
        }
    ...
    fn next_turn(&mut self) {
        self.pieces_dropped[self.index_of_pieces(self.current_player)] += 1;
    ...
    fn index_of_pieces(&self, piece: BoardPiece) -> usize {
